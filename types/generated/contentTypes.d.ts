...
export interface ApiItemItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    item_created_at_: Schema.Attribute.DateTime;
    item_id: Schema.Attribute.BigInteger;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_created_at: Schema.Attribute.DateTime;
    order_id: Schema.Attribute.BigInteger;
    order_status: Schema.Attribute.Enumeration<
      ['pending', 'preparing', 'delivered', 'cancelled']
    >;
    order_updated_at: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
